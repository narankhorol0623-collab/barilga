    ...
    <>
      <header className={headerClass}>
        ...
        <nav className="flex gap-11 text-xs font-bold tracking-[.08em] max-[760px]:hidden [&_a]:border-b-2 [&_a]:border-transparent [&_a]:py-2.5 [&_a]:text-[#c4ccdc] [&_a]:hover:border-[#60dda2] [&_a]:hover:text-[#60dda2] in-data-[theme=light]:[&_a]:text-[#526078]">
          <Link className="!border-[#60dda2] !text-[#60dda2]" href="/">
            Нүүр
          </Link>
      ...
      <main>
        <section className="relative isolate flex h-svh min-h-[680px] items-center overflow-hidden bg-[radial-gradient(circle_at_76%_34%,rgba(20,93,148,.22),transparent_31%),radial-gradient(circle_at_25%_72%,rgba(32,68,135,.1),transparent_28%),linear-gradient(125deg,#0a1128_0%,#0a1128_58%,#0d1732_100%)] px-[clamp(20px,7vw,120px)] pb-[60px] pt-[100px] max-[760px]:min-h-[760px] max-[760px]:px-4 max-[760px]:pb-20 in-data-[theme=light]:bg-[radial-gradient(circle_at_76%_34%,rgba(20,93,148,.13),transparent_31%),radial-gradient(circle_at_25%_72%,rgba(96,221,162,.1),transparent_28%),linear-gradient(125deg,#f7f9fc_0%,#eef3f9_58%,#e6edf6_100%)] after:absolute after:right-[-20%] after:top-[10%] after:h-[60vw] after:w-[60vw] after:rotate-[35deg] after:border after:border-[#a0b2da]/8 after:content-['']">
          ...
          <div className="relative z-[2] max-w-[850px] py-3">
            <div className="mb-7 inline-flex items-center gap-2.5 rounded-full border border-[#60dda2]/20 bg-[#101d3b]/70 px-4 py-2.5 text-xs font-extrabold tracking-[.18em] text-[#60dda2] shadow-[0_12px_38px_rgba(0,0,0,.16)] backdrop-blur-lg in-data-[theme=light]:bg-white/70 in-data-[theme=light]:text-[#087a55]">
              <i className="size-2 rounded-full bg-[#60dda2]" /> ШИНЭ ТӨСӨЛ
              НЭЭЛТТЭЙ
            </div>
            ...
            <div className="flex items-stretch gap-4 max-[760px]:flex-col">
              <a className={primaryButtonClass} href="#projects">
                ТӨСЛҮҮДТЭЙ ТАНИЛЦАХ
              </a>
              <a
          ...
          <img
            className="absolute bottom-6 left-[clamp(20px,7vw,120px)] size-8 object-contain opacity-90 max-[760px]:bottom-[30px] max-[760px]:size-[26px]"
          ...
          <a
            ...
            href="#about"
          >
            SCROLL <b className="block text-[26px] text-[#60dda2]">⌄</b>
          </a>
        </section>
          ...
          <div className="mx-auto max-w-[1240px]">
            <div className="grid grid-cols-[.8fr_1.2fr] gap-20 max-[900px]:grid-cols-1 max-[900px]:gap-8">
              <div>
                ...
                <h2 className="mt-3 text-[clamp(34px,4vw,56px)] leading-[1.08] tracking-[-.04em]">
                  Туршлагаас
                  <br />
                  <span className="text-[#60dda2]">үнэ цэн бүтээнэ.</span>
                </h2>
              </div>
            ...
            <div className="relative mt-16 grid grid-cols-4 gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/10 max-[820px]:grid-cols-2 max-[480px]:grid-cols-1 in-data-[theme=light]:border-[#ccd5e2] in-data-[theme=light]:bg-[#ccd5e2]">
              {milestones.map((item) => (
                <article
                  ...
                  key={item.year}
                >
                  <strong className="text-[32px] tracking-[-.04em] text-[#60dda2]">
                    {item.year}
                  </strong>
            ...
            >
              ...
              <div className="relative grid grid-cols-[auto_1fr] gap-10 max-[760px]:grid-cols-1 max-[760px]:gap-5">
                <div className="text-[56px] font-black leading-none text-[#60dda2]">
                ...
                <div>
                  ...
                  <div className="mt-6 flex flex-wrap gap-3 text-xs font-extrabold tracking-[.08em]">
                    <span className="rounded-full border border-[#60dda2]/30 px-4 py-2 text-[#60dda2]">
                      5 БЛОК
                    </span>
                    <span className="rounded-full border border-[#60dda2]/30 px-4 py-2 text-[#60dda2]">
                      22 АМИНЫ ОРОН СУУЦ
            ...
            <div className="grid grid-cols-2 gap-6 max-[760px]:grid-cols-1">
              <article
                className={`${glassClass} rounded-2xl border-t-4 border-t-[#60dda2] p-8 max-[760px]:p-6`}
              >
            ...
            <div className="mt-20 max-[760px]:mt-14">
              ...
              <div className="grid grid-cols-3 gap-4 max-[900px]:grid-cols-2 max-[600px]:grid-cols-1">
                {values.map((value) => (
                  <article
                    className={`${glassClass} group rounded-xl p-6 transition-colors hover:border-[#60dda2]/50`}
                    key={value.no}
                  >
                    <span className="text-xs font-extrabold tracking-[.16em] text-[#60dda2]">
                      {value.no}
                    </span>
                    <h3 className="mb-3 mt-6 text-xl font-bold group-hover:text-[#60dda2]">
                      {value.title}
                    </h3>
          ...
          <div className="grid grid-cols-2 gap-6 max-[760px]:grid-cols-1">
            {projects.map((project) => (
              ...
              >
                ...
                />
                <span className="absolute right-5 top-5 z-[3] rounded-full border border-[#60dda2]/50 bg-[#051414]/70 px-3.5 py-[7px] text-[11px] font-extrabold text-[#60dda2]">
                  {project.status}
                </span>
      ...
      <nav className={bottomNavClass}>
        <Link className="!text-[#60dda2]" href="/">
          ⌂<span>НҮҮР</span>
        </Link>
